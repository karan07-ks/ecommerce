    ...
    return `<div class="bag-item-container">
        ...
        <div class="item-right-part">
            ...
            <div class="quantity-controls">
                <img class="decrement-quantity" src="icon2.png" alt="-" onclick="updateQuantity('${item.id}', -1)">
                <span class="quantity-value">${item.quantity || 1}</span>
                <img class="increment-quantity" src="icon1.png" alt="+" onclick="updateQuantity('${item.id}', 1)">
            </div>
        </div> 
